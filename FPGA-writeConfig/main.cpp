...
bool performHPStoFPGAReset(bool ConsloeOutput, uint8_t reset_typ)
{
	...
	if(reset_typ ==1) 		(void) system( (const char*) "FPGA-writeBridge -mpu 0xFFD05020 -b 6 1 -b");
	else if(reset_typ ==2)  (void)  system( (const char*) "FPGA-writeBridge -mpu 0xFFD05020 -b 7 1 -b");
	// Perform a Bridge Reset
	else if(reset_typ==3)	(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 1 1 -b");
	else if(reset_typ==4)	(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 0 1 -b");
	else if(reset_typ==5)	(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 2 1 -b");
	...
	// Perform Cold or Warm FPGA Reset
	if(reset_typ ==1) 		(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD05020 -b 6 0 -b");
	else if(reset_typ ==2) (void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD05020 -b 7 0 -b");
	// Perform a Bridge Reset
	else if(reset_typ==3)	(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 1 0 -b");
	else if(reset_typ==4)	(void)  system((const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 0 0 -b");
	else if(reset_typ==5)	(void)  system( (const char*) "FPGA-writeBridge -mpu 0xFFD0501C -b 2 0 -b");
